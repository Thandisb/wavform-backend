...
VALUES
    (1, 'Notes on the Piano and Octaves'),
    (1, 'Intervals and Chords'),
    (1, 'Scales'),
    (1, 'Piano Practice'),
    (2, 'Bars and Types of Notes'),
    (2, 'Tempo');

INSERT INTO 
    topics_details (topics_id, description)
VALUES
    (1, 'There are 8 notes in music, ABCDEFG.'),
    (1, 'The notes on the piano are ABCDEFG.'),
    (1, 'This sequence of notes repeats. Example: ABCDEFGABCDEFG.'),
    (1, 'Every repetition is called an octave.'),
